...
const AdminCourses = () => {
  ...
  // Load courses function wrapped in useCallback to satisfy ESLint
  ...
  const handleAddLecture = (id) => setActiveCourse(id);
  ...
  const submitLecture = async (courseId) => {
    ...
    try {
      ...
      // Use full backend URL for Vercel deployment
      const res = await fetch('https://lms-backend-red-five.vercel.app/upload-video', { 
        method: 'POST', 
        body: fd 
      });
